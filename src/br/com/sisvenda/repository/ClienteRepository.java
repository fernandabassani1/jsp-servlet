...
public class ClienteRepository {
	...
	String sql_select_nome_cpf = "SELECT * FROM cliente c WHERE c.nome LIKE ? AND c.cpf LIKE ?";
	String sql_delete = "DELETE FROM cliente WHERE id = ?";
	String sql_update = "UPDATE  cliente c set c.nome = ? , c.cpf = ? where c.id = ?"; //ATUALIZAR
